...
int stopRequestedInDirection__before__twothirdsfull(int dir,
                                                    int respectFloorCalls,
...
int stopRequestedInDirection__role__twothirdsfull(int dir,
                                                  int respectFloorCalls,
                                                  int respectInLiftCalls) {
  int retValue_acc = unknown();
  int overload;
...

  {
    ...
    if (overload) {
      if (buttonPressed) {
        {
          retValue_acc = stopRequestedInDirection__before__twothirdsfull(
              dir, 0, respectInLiftCalls);
        }
        return (retValue_acc);
      } else {
        {
          retValue_acc = stopRequestedInDirection__before__twothirdsfull(
              dir, respectFloorCalls, respectInLiftCalls);
        }
        return (retValue_acc);
      }
    } else {
...
int stopRequestedInDirection__before__executivefloor(int dir,
                                                     int respectFloorCalls,
                                                     int respectInLiftCalls) {
  int retValue_acc = unknown();

  {
    if (__SELECTED_FEATURE_twothirdsfull) {
      {
        retValue_acc = stopRequestedInDirection__role__twothirdsfull(
            dir, respectFloorCalls, respectInLiftCalls);
      }
      return (retValue_acc);
    } else {
...
int stopRequestedInDirection__role__executivefloor(int dir,
                                                   int respectFloorCalls,
                                                   int respectInLiftCalls) {
  int retValue_acc = unknown();
  int tmp;
...

  {
    ...
    if (tmp___0) {
      ...
      {
        retValue_acc = stopRequestedInDirection__before__executivefloor(
            dir, respectFloorCalls, respectInLiftCalls);
      }
      return (retValue_acc);
    }
...
int stopRequestedInDirection(int dir, int respectFloorCalls,
                             int respectInLiftCalls) {
  int retValue_acc = unknown();

  {
    if (__SELECTED_FEATURE_executivefloor) {
      {
        retValue_acc = stopRequestedInDirection__role__executivefloor(
            dir, respectFloorCalls, respectInLiftCalls);
      }
      return (retValue_acc);
    } else {
...
void *__utac__error_stack_mgt(void *env, int mode, int count) {
  void *retValue_acc = (void *)__VERIFIER_nondet_long();
    ...
    if (i > 0) {
      {
        ...
        if (i <= __cil_tmp6) {
          ...
          {
            __assert_fail("i > 0 && i <= this->argsCount", "libacc.c", 123U,
    ...
    if (i > 0) {
      {
        ...
        if (i <= __cil_tmp6) {
          ...
          {
            __assert_fail("i > 0 && i <= this->argsCount", "libacc.c", 131U,
