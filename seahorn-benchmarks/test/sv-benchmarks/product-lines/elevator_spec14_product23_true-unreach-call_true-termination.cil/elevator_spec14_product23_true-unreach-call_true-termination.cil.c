...
int stopRequestedInDirection__wrappee__weight(int dir, int respectFloorCalls,
...
int stopRequestedInDirection__wrappee__twothirdsfull(int dir,
...

  {
    ...
    if (overload) {
      if (buttonPressed) {
        {
          retValue_acc = stopRequestedInDirection__wrappee__weight(
...
int stopRequestedInDirection(int dir, int respectFloorCalls,
...

  {
    ...
    if (tmp___0) {
      ...
      {
        retValue_acc = stopRequestedInDirection__wrappee__twothirdsfull(
            dir, respectFloorCalls, respectInLiftCalls);
      }
      return (retValue_acc);
    }
